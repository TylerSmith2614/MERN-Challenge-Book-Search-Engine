...
Refactored a app using Google Books API to use apollo server and graphql. GraphQL queries and mutations are now used to fetch and modify data insead of the existing RESTful API.
Authentication was set up using JWT.

I do not have access to heroku so the application was deployed on amazon web services.

## Note of assistance with source code

I was helped by a classmate Michael Gibson. He helped me problem solve an error I was getting in the server/utils/auth.js file with an "invalid token" error. He also helped me with my general file structure and graphQL set up.

## Screenshots

![Alt text](<Develop/Assets/Screenshot 2023-08-14 154709.png>)
